...
(deftest test-feedback
  (testing "That it gives the right feedback"
    (is (= {:result :bomb :pos [0 1] :board [[0 :bomb] [0 0]] :reopened false} (open [0 1] [[0 :bomb] [0 0]] false)) "Opening a bomb gives bomb")
    (is (= {:result :open :pos [0 1] :board [[0 :open] [0 0]] :reopened false} (open [0 1] [[0 :open] [0 0]] false)) "Opening already opened")
    (is (= {:result 1 :pos [1 1] :board [[0 0 0] [:bomb :open 0] [0 0 0]] :reopened false} (open [1 1] [[0 0 0] [:bomb 0 0] [0 0 0]] false)) "Opening a field gives updated value")
